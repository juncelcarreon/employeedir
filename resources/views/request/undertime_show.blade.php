		...
		<div class="row" id="printable">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p style="margin-left: 10px;"><?= slashedDate($undertime->created_at) ?></p>
                </div>
            ...
            <?php
        	if($undertime->supervisor_id == Auth::user()->isAdmin() && empty($undertime->recommend_date) && $undertime->status == 'PENDING') {
            ?>
