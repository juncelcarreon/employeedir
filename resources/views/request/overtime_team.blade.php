...
<div class="panel panel-default">
    <div class="panel-heading">
        <a href="<?= url('team-overtime') ?>"<?= ($type == 'pending') ? ' class="active"' : '' ?>>PENDING</a> | 
        <a href="<?= url('team-overtime?status=approved') ?>"<?= ($type == 'approved') ? ' class="active"' : '' ?>>APPROVED</a> | 
        <a href="<?= url('team-overtime?status=verifying') ?>"<?= ($type == 'verifying') ? ' class="active"' : '' ?>>VERIFYING</a> | 
        <a href="<?= url('team-overtime?status=completed') ?>"<?= ($type == 'completed') ? ' class="active"' : '' ?>>COMPLETED</a> | 
        <a href="<?= url('team-overtime?status=declined') ?>"<?= ($type == 'declined') ? ' class="active"' : '' ?>>DECLINED</a>
