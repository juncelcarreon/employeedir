...
@section('title')
    Request | Leave > Team Leave
@endsection
@section('content')
<style type="text/css">
    .panel-heading a{ color: #fff; }
    .panel-heading a.text-danger{ color: #ffff00; }
...
<div class="panel panel-default">
    <div class="panel-heading">
        <a href="<?= url('for-approval') ?>"<?= ($type == 'pending') ? ' class="active"' : '' ?>>Pending Leaves of Your Team</a> | 
        <a href="<?= url('team-approves') ?>"<?= ($type == 'approve') ? ' class="active"' : '' ?>>Approved Leaves of Your Team</a> | 
        <a href="<?= url('team-cancelled') ?>" class="text-danger<?= ($type == 'cancelled') ? ' active' : '' ?>">Cancelled Leaves of Your Team</a>
