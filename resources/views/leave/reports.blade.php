    ...
    <div class="col-md-12">
        <div class="panel panel-default mb-0">
            <div class="panel-heading">
                ...
                if(isset($target)) {
                ?>
                <a href="<?= url("download-report?from={$target['from']}&to={$target['to']}&type={$target['type']}") ?>" class="btn btn-md btn-success pull-right"><span class="fa fa-download"></span>&nbsp; Download</a>
                <?php
                } else {
                ?>
                <a href="#" class="btn btn-md btn-success pull-right"><span class="fa fa-download"></span>&nbsp; Download</a>
                <?php
                }
                ?>
