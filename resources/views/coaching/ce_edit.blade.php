...
@section('title')
Linking Sessions > Cementing Expectation > Edit Session
@endsection
@section('breadcrumb')
Linking Sessions <span>/</span> Cementing Expectation <span>></span> Edit Session
@endsection
@section('content')
<style>
@include('coaching.style');
</style>
<form action="<?= url('update-ce-expectation') ?>" method="post" autocomplete="off">
    {{ csrf_field() }}
            ...
            <div class="row d-flex">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="se_focus" class="form-control select2" required>
                            ...
                            ?>
                            <option value="<?= $ss->fc_id ?>"<?= ($obj->se_focus == $ss->fc_id) ? " selected" : ""?>><?= $ss->fc_desc ?></option>
                            <?php
                            }
                            ?>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="se_skill" class="form-control" value="<?= $obj->se_skill ?>" required>
                        <div class="form-text d-none"></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="se_when_use" class="form-control" value="<?= $obj->se_when_use ?>" required>
                        <div class="form-text d-none"></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="se_how_use" class="form-control" value="<?= $obj->se_how_use ?>" required>
                        <div class="form-text d-none"></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="se_why_use" class="form-control" value="<?= $obj->se_why_use ?>" required>
                        <div class="form-text d-none"></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="se_expectations" class="form-control" value="<?= $obj->se_expectations ?>" required>
                        <div class="form-text d-none"></div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="se_comments" rows="10" class="form-control" required><?= $obj->se_comments ?></textarea>
                        <div class="form-text d-none"></div>
                    </div>
                </div>
            </div>
