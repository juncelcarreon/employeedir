    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?= empty($linkee) ? $obj['lnk_linkee_name'] : $linkee->fullName2() ?>'s Accountability Setting History</h5>
                ...
                <table class="table table-striped table-bordered" id="table-history">
                    ...
                    <tbody>
                        ...
                        foreach($history as $lk) {
                            if(empty($obj->ac_com_id) || $obj->ac_com_id != $lk->ac_com_id) {
                                $url = url("acc-set-edit/{$lk->ac_com_id}");
                                if($lk->lnk_acknw) {
                                    $url = url("acc-set/{$lk->ac_com_id}");
                                }
                        ?>
                        <tr>
