    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?= empty($linkee) ? $obj['lnk_linkee_name'] : $linkee->fullName2() ?>'s Goal Setting History</h5>
                ...
                <table class="table table-striped table-bordered" id="table-history">
                    ...
                    <tbody>
                        ...
                        foreach($history as $lk) {
                            if(empty($obj->gs_com_id) || $obj->gs_com_id != $lk->gs_com_id) {
                                $url = url("goal-setting-edit/{$lk->gs_com_id}");
                                if($lk->lnk_acknw) {
                                    $url = url("goal-setting/{$lk->gs_com_id}");
                                }
                        ?>
                        <tr>
