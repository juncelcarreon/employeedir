    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?= empty($linkee) ? $obj['lnk_linkee_name'] : $linkee->fullName2() ?>'s Getting to Know You History</h5>
                ...
                <table class="table table-striped" id="table-history">
                    ...
                    <tbody>
                        ...
                        foreach($history as $lk) {
                            if(empty($obj->gtk_com_num) || $obj->gtk_com_num != $lk->gtk_com_num) {
                                $url = url("gtky-edit/{$lk->gtk_com_num}");
                                if($lk->lnk_acknw) {
                                    $url = url("gtky/{$lk->gtk_com_num}");
                                }
                        ?>
                        <tr>
