...
@section('title')
Linking Sessions > Getting To Know You > View Session
@endsection
@section('breadcrumb')
Linking Sessions <span>/</span> Getting To Know You <span>></span> View Session
@endsection
@section('content')
<style>
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Anything else you like to add</label>
                    <textarea name="gtk_others" rows="5" class="form-control" readonly><?= $obj->gtk_others ?></textarea>
                </div>
            </div>
        </div>
    </div>
