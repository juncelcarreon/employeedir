...
@section('title')
Linking Sessions > Skills Development Activity > New Session
@endsection
<style>
            ...
            <div class="row">
                <div class="col-md-6"><!-- Left Panel -->
                    <form id="form_quick_link" autocomplete="off">
                        <div class="row">
                            <div class="col-md-12" style="padding: 12px;"><b style="color: #0000FF; font-size: 16px;"><?= ($obj['view_only']) ? "View " : "New " ?>Skills Development Activity Session</b></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="sda_date_call" id="sda_date_call" class="form-control" value="<?= $obj['sda_date_call'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="sda_call_sel" id="sda_call_sel" class="form-control" value="<?= $obj['sda_call_sel'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <textarea id="sda_www_u_said" name="sda_www_u_said" rows="7" class="form-control"><?= $obj['sda_www_u_said'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <textarea id="sda_www_i_said" name="sda_www_i_said" rows="7" class="form-control"><?= $obj['sda_www_i_said'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <textarea id="sda_wcm_u_said" name="sda_wcm_u_said" rows="7" class="form-control"><?= $obj['sda_wcm_u_said'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <textarea id="sda_www_i_said" name="sda_wcm_i_said" rows="7" class="form-control"><?= $obj['sda_wcm_i_said'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <textarea id="exampleSDAComments" name="sda_comments" rows="10" class="form-control"><?= $obj['sda_comments'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="submit" name="save_sda_linking" id="btn-process_submit" class="btn btn-lg btn-primary" value="<?= ($obj['update']) ? "UPDATE" : "SAVE" ?> SDA LINKING">
                                </div>
                            </div>
                        </div>
                    </form>
...
function initVals() {
    ...
    var sda_type = <?= $obj['sda_type'] ? 1 : 0 ?>;
    var sda_date_call = <?= $obj['sda_date_call'] ? 1 : 0 ?>;
    var sda_call_sel = <?= $obj['sda_call_sel'] ? 1 : 0 ?>;
    var sda_www_u_said = <?= $obj['sda_www_u_said'] ? 1 : 0 ?>;
    var sda_www_i_said = <?= $obj['sda_www_i_said'] ? 1 : 0 ?>;
    var sda_wcm_u_said = <?= $obj['sda_wcm_u_said'] ? 1 : 0 ?>;
    var sda_wcm_i_said = <?= $obj['sda_wcm_i_said'] ? 1 : 0 ?>;
    var sda_comments = <?= $obj['sda_comments'] ? 1 : 0 ?>;
