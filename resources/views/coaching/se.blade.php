                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="se_skill" class="form-control" value="<?= $obj['se_skill'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <input id="exampleInputSeWhenUse" type="text" name="se_when_use" class="form-control" value="<?= $obj['se_when_use'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="exampleInputSeHowUse" type="text" name="se_how_use" class="form-control" value="<?= $obj['se_how_use'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <input id="exampleInputSeWhyUse" type="text" name="se_why_use" class="form-control" value="<?= $obj['se_why_use'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <input id="exampleInputSeMyExpect" type="text" name="se_expectations" class="form-control" value="<?= $obj['se_expectations'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    ...
                                    <textarea id="exampleSEComments" name="se_comments" rows="10" class="form-control"><?= $obj['se_comments'] ?></textarea>
