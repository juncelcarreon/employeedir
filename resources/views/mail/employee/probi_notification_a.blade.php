...
<br>
<br>
This is to remind you that {{ $obj_details['emp_name'] }} who was hired last {{ $obj_details['date_hired'] }} is due for a 3-Month Performance review on {{ $obj_details['date'] }}.  Kindly submit your Performance Evaluation before {{ $obj_details['due_date'] }}. 
<br>
<br>
